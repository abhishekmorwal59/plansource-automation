...
//        logger.info("Close save address and address save prompt");
//
//
//
...
//
//
//       // planPage.isHSASurveyHeadingDisplayed();
//    //    planPage.clickYesOnHsaQuestion();
//    //    planPage.clickNextSave();
//
//
...
//
//        // Cleanup old PDFs BEFORE download
//        String downloadDir = System.getProperty("user.home") + "/Downloads";
//        FileUtil.cleanOldPDFs(downloadDir);
//
//        confirmationPage.downloadConfirmationPDF(); // Now download the PDF
//
//        System.out.println("Looking for file in: " + downloadDir);
